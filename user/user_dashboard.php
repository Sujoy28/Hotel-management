        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              <a href="user_dashboard.php" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="briefcase"></i><span>Room Details</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="view_customer.php">user view</a></li>
                
                <li><a class="nav-link" href="add_customer.php">Add user</a></li>
