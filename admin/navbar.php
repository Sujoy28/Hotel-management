        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              ...
              <a href="admin_logout.php" class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i>
                Logout
              </a>
            </div>
          </li>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="briefcase"></i><span>Room Details</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="view_room.php">Room view</a></li>
                
                <li><a class="nav-link" href="add_room.php">Add room </a></li>
                
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="briefcase"></i><span>Customer Details</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="view_customer.php">Customer details view</a></li>
                <li><a class="nav-link" href="add_customer.php">Add customer details</a></li>
                
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="command"></i><span>Booking status</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="current_book.php">Today's booking</a></li>
                <li><a class="nav-link" href="upcoming_book.php">Upcoming booking</a></li>
                <li><a class="nav-link" href="previous_book.php">Previous booking</a></li>
                <li><a class="nav-link" href="#">Cancel booking</a></li>
